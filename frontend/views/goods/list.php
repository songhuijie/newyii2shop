...
<div class="list w1210 bc mt10">
    ...
    <div class="breadcrumb">
        <h2>当前位置：<?=\yii\helpers\Html::a('首页',['index/index'])?>> <?=\yii\helpers\Html::a($goodscategory->name,['goods/list','id'=>$goodscategory->id])?><?=isset($brand_id)?'>'.$good->brand->name:''?></h2>
    </div>
    <!-- 面包屑导航 end -->
    ...
    <div class="list_left fl mt10">
        ...
        <div class="catlist">
            ...
            <div class="catlist_wrap">
                <?php foreach($goodscategory->chlidren as $chlid):?>
                <div class="child">
                    <h3 class="on"><b></b><?=$chlid->name?></h3>
                    <ul>
                    <?php foreach($chlid->chlidren as $c):?>
    ...
    <div class="list_bd fl ml10 mt10">
        ...
        <div class="filter mt10">
            ...
            <div class="filter_wrap">
                <dl>
                    <dt>品牌：</dt>
                    <dd <?=isset($brand_id)?'':'class="cur"'?>><a href="">不限</a></dd>
                    <?php foreach ($brands as $brand):?>
                        <dd <?=isset($brand_id) && ($good->brand->name==$brand->name)?'class="cur"':'';?>>
                            <?=\yii\helpers\Html::a($brand->name,['list2','id'=>$id,'brand_id'=>$brand->id])?>
                            </dd>
                    <?php endforeach;?>
        ...
        <div class="goodslist mt10">
            <ul>
               ...
               <li>
                     <dl>
                        <dt><a href="index?id=<?=$good->id?>&name=<?=$goodscategory->name?>"><?php if($good->logo) echo \yii\helpers\Html::img('http://www.yii2shop.cc.cn/'.$good->logo,['width'=>200])?></a></dt>
