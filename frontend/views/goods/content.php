...
<div class="main w1210 mt10 bc">
    ...
    <div class="breadcrumb">
        <h2>当前位置：<?=\yii\helpers\Html::a('首页',['index/index'])?> > <?=\yii\helpers\Html::a($category->name,['goods/list','id'=>$category->id])?> >  <?=$goods->name?></h2>
    </div>
    <!-- 面包屑导航 end -->
    ...
    <div class="goods_left fl">
        ...
        <div class="related_view newgoods leftbar mt10">
            ...
            <div class="leftbar_wrap">
                <ul>
                    <li>
                        <dl>
                            <dt><a href=""><?=\yii\helpers\Html::img(\Yii::getAlias('@web/images/relate_view1.jpg'))?>
</a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><?=\yii\helpers\Html::img(\Yii::getAlias('@web/images/relate_view2.jpg'))?>
</a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><?=\yii\helpers\Html::img(\Yii::getAlias('@web/images/relate_view3.jpg'))?>
</a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><?=\yii\helpers\Html::img(\Yii::getAlias('@web/images/relate_view4.jpg'))?>
</a></dt>
                    ...
                    <li class="last">
                        <dl>
                            <dt><a href=""><?=\yii\helpers\Html::img(\Yii::getAlias('@web/images/relate_view5.jpg'))?>
</a></dt>
        ...
        <div class="viewd leftbar mt10">
            ...
            <div class="leftbar_wrap">
                <dl>
                    <dt><a href=""><?=\yii\helpers\Html::img(\Yii::getAlias('@web/images/hpG4.jpg'))?>
</a></dt>
                    <dd><a href="">惠普G4-1332TX 14英寸笔记...</a></dd>
                </dl>

                <dl class="last">
                    <dt><a href=""><?=\yii\helpers\Html::img(\Yii::getAlias('@web/images/crazy4.jpg'))?>
</a></dt>
            ...
            <div class="preview fl">
                <div class="midpic">
                    <a href="images/preview_l1.jpg" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <?=\yii\helpers\Html::img('http://www.yii2shop.cc.cn'.$goods->logo,['width'=>300])?>           <!-- 第一幅图片的中图 -->
                    </a>
                </div>
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            <!--<li class="cur">
                                <a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'images/preview_m1.jpg',largeimage: 'images/preview_l1.jpg'}">/*=\yii\helpers\Html::img(\Yii::getAlias('@web/images/preview_s1.jpg'))*/</a></li>-->
                                <?php
//                                var_dump($goodsimg);exit;
                                if(!empty($goodsimg)){

                                    foreach($goodsimg as $good){

                                        echo '<li class="cur">';
                                        echo \yii\helpers\Html::img('http://www.yii2shop.cc.cn/'.$good['img']);
                                        echo '</li>';
                                    }
                                }
                                ?>
            ...
            <div class="goodsinfo fl ml10">
                <ul>
                    ...
                    <li><span>上架时间：</span><?=date('Y-d-m',$goods->create_time)?></li>
<!--                    <li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有21人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
                </ul>

                <form action="<?=\yii\helpers\Url::to(['pay/cookie'])?>" method="post" class="choose">
                    <ul>
                        ...
                        <li>
                            <dl>
                                <dt>&nbsp;</dt>
                                <dd>
<!--                                    post提交有跨域攻击验证 需要给他一个验证 不然无法提交-->                    <input name="goods_id" value="<?=$goods->id?>"/>
                ...
                <div class="introduce detail_div none">
                    <div class="attr mt15">
                        <ul>
                            ...
                            <li><span>上架时间：</span><?=date('Y-d-m H:i:s',$goods->create_time)?></li>
