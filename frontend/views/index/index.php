...
<div class="colligate w1210 bc mt10">
    ...
    <div class="slide fl">
        <div class="area">
            <div class="slide_items">
                <ul>
                    <li><a href=""><?=\yii\helpers\Html::img(\Yii::getAlias('@web/images/index_slide1.jpg'))?></li>
                    <li><a href=""><?=\yii\helpers\Html::img(\Yii::getAlias('@web/images/index_slide2.jpg'))?></li>
                    <li><a href=""><?=Html::img(\Yii::getAlias('@web/images/index_slide3.jpg'))?></li>
                    <li><a href=""><?=Html::img(\Yii::getAlias('@web/images/index_slide4.jpg'))?></li>
                    <li><a href=""><?=Html::img(\Yii::getAlias('@web/images/index_slide5.jpg'))?></li>
                    <li><a href=""><?=Html::img(\Yii::getAlias('@web/images/index_slide6.jpg'))?></li>
                </ul>
            </div>
    ...
    <div class="coll_right fl ml10">
        <div class="ad"><a href=""><?=Html::img(\Yii::getAlias('@web/images/ad.jpg'))?></div>
        ...
        <div class="service mt10">
            ...
            <div class="service_wrap">
                ...
                <div class="travel none">
                    <ul>
                        <li>
                            <a href=""><?=Html::img(\Yii::getAlias('@web/images/holiday.jpg'))?></a>
                            <a href="" class="button">度假查询</a>
                        </li>
                        <li>
                            <a href=""><?=Html::img(\Yii::getAlias('@web/images/scenic.jpg'))?></a>
                ...
                <div class="lottery none">
                    <p><?=Html::img(\Yii::getAlias('@web/images/lottery.jpg'))?></p>
                </div>
                <!-- 彩票 end -->
                ...
                <div class="game none">
                    <ul>
                        <li><a href=""><?=Html::img(\Yii::getAlias('@web/images/sanguo.jpg'))?></a></li>
                        <li><a href=""><?=Html::img(\Yii::getAlias('@web/images/taohua.jpg'))?></a></li>
                        <li><a href=""><?=Html::img(\Yii::getAlias('@web/images/wulin.jpg'))?></a></li>
                    </ul>
                </div>
                <!-- 游戏 end -->
            </div>
        ...
        <div class="guide_wrap">
            ...
            <div class="crazy">
                <ul>
                    <li>
                        <dl>
                            <dt><a href=""><?=Html::img(\Yii::getAlias('@web/images/crazy1.jpg'))?></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><?=Html::img(\Yii::getAlias('@web/images/crazy2.jpg'))?></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><?=Html::img(\Yii::getAlias('@web/images/crazy3.jpg'))?></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><?=Html::img(\Yii::getAlias('@web/images/crazy4.jpg'))?></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><?=Html::img(\Yii::getAlias('@web/images/crazy5.jpg'))?></a></dt>
            ...
            <div class="hot none">
                <ul>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><?=\yii\helpers\Html::img(\Yii::getAlias('@web/images/hot2.jpg'))?>
                                   </a></dt>
            ...
            <div class="recommend none">
                <ul>
                    <li>
                        <dl>
                            <dt><a href=""><?=\yii\helpers\Html::img(\Yii::getAlias('@web/images/recommend1.jpg'))?>
                                   </a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><?=\yii\helpers\Html::img(\Yii::getAlias('@web/images/recommend2.jpg'))?>
                                    </a></dt>
...
<div class="floor1 floor w1210 bc mt10">
            ...
            <div class="goodslist_wrap">
                <div>
                    <ul>
                        ...
                        <li>
                            <dl>
                                <dt><a href=""><?=\yii\helpers\Html::img(\Yii::getAlias('@web/images/qinghuax2.jpg'))?>
</a></dt>
                ...
                <div class="none">
                    <ul>
                        <li>
                            <dl>
                                <dt><a href=""><?=\yii\helpers\Html::img(\Yii::getAlias('@web/images/thinkpad e420.jpg'))?>
</a></dt>
                                <dd><a href="">ThinkPad E42014英寸笔..</a></dd>
                                <dd><span>售价：</span> <strong>￥4199.00</strong></dd>
                            </dl>
                        ...
                        <li>
                            <dl>
                                <dt><a href=""><?=\yii\helpers\Html::img(\Yii::getAlias('@web/images/acer4739.jpg'))?>
</a></dt>
                                <dd><a href="">宏碁AS4739-382G32Mnk</a></dd>
                                <dd><span>售价：</span> <strong>￥2799.00</strong></dd>
                            </dl>
    ...
    <div class="sidebar fl ml10">
        ...
        <div class="brand">
            ...
            <div class="sidebar_wrap">
                <ul>
                    <li><a href=""><?=\yii\helpers\Html::img(\Yii::getAlias('@web/images/dell.gif'))?>
</a></li>
                    <li><a href=""><?=\yii\helpers\Html::img(\Yii::getAlias('@web/images/acer.gif'))?>
</a></li>
                    <li><a href=""><?=\yii\helpers\Html::img(\Yii::getAlias('@web/images/fujitsu.jpg'))?>
</a></li>
                    <li><a href=""><?=\yii\helpers\Html::img(\Yii::getAlias('@web/images/hp.jpg'))?>
</a></li>
                    <li><a href=""><?=\yii\helpers\Html::img(\Yii::getAlias('@web/images/lenove.jpg'))?>
</a></li>
                    <li><a href=""><?=\yii\helpers\Html::img(\Yii::getAlias('@web/images/samsung.gif'))?>
</a></li>
                    <li><a href=""><?=\yii\helpers\Html::img(\Yii::getAlias('@web/images/dlink.gif'))?>
</a></li>
                    <li><a href=""><?=\yii\helpers\Html::img(\Yii::getAlias('@web/images/seagate.jpg'))?>
</a></li>
                    <li><a href=""><?=\yii\helpers\Html::img(\Yii::getAlias('@web/images/intel.jpg'))?>
</a></li>
                </ul>
            </div>
        </div>
        ...
        <!-- 广告 start -->
        <div class="ads mt10">
            <a href=""><?=\yii\helpers\Html::img(\Yii::getAlias('@web/images/canon.jpg'))?>
</a>
        </div>
        <!-- 广告 end -->
    </div>
